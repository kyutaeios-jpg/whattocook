...
- 공백/괄호 차이: "돈가스 소스"="돈가스소스"
- 냉동/해동 차이: "냉동 블루베리"→"블루베리" (냉장고에 있으면 쓸 수 있음)
- 같은 이름으로 통칭: 진간장, 양조간장 → "간장" (마트에서 "간장"이라고 부름)
- 같은 이름으로 통칭: 황설탕, 백설탕 → "설탕", 꽃소금 → "소금"

묶으면 안 되는 것:
- 일상에서 별도 이름으로 부르는 것: 국간장≠간장 (용도와 맛이 달라 별도로 부름)
- 다른 부위: 삼겹살≠대패삼겹살≠목살≠앞다리살
- 다른 종류의 양념: 참기름≠들기름, 고춧가루≠고추장
